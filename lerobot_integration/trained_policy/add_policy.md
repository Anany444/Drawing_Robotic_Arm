...
Due to GitHub's strict 100MB file size limit, the trained model weights are not stored in this repository. Instead, they are hosted securely on the Hugging Face Model Hub.
